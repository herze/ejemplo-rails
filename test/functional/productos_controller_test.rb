...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { description: @producto.description, image_url: @producto.image_url, price: @producto.price, title: @producto.title }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { description: @producto.description, image_url: @producto.image_url, price: @producto.price, title: @producto.title }
    assert_redirected_to producto_path(assigns(:producto))
  end
